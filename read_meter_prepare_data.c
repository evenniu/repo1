...
READ_WRITE_DATA const LAST_CURVE_CYCLE_DAY_PHY_LIST[] =
{
    ...
    {(FHJL5_GLYS_14-0x3F),       PIM_LAST_CURVE_DAY_TMP3   ,  5+8+8+CURVE_RESERVE_SIZE ,        SAVE_FLAG_DENY_NO_SAVE|SAVE_FLAG_BLOCK|4, 0,  2, }, RDATA_CURVE ,  6+5+45+RESERVE_DATA,    SAVE_FLAG_DENY_NO_SAVE,                      0,  45, },   //	0x02800113 //上1小时负荷记录
